...
void mock.module(nodePath.resolve(import.meta.dir, './adapters/cli/entry.ts'), () => ({
...
afterAll(() => {
  mock.restore();
  void mock.module(nodePath.resolve(import.meta.dir, './adapters/cli/entry.ts'), () => __origCliEntry);
});
